...
const LocationManagement = () => {
  ...
  const updateUniversity = (id: string, updates: Partial<University>) => {
    setUniversities(
      universities.map((uni) => (uni.id === id ? { ...uni, ...updates } : uni))
    );
  ...
  const addPricingRule = () => {
    if (
      newPricingRule.fromLocation &&
      newPricingRule.toLocation &&
      newPricingRule.basePrice
    ) {
      const id = Date.now().toString();
      setPricingRules([
        ...pricingRules,
        { id, ...newPricingRule } as PricingRule,
      ]);
      setNewPricingRule({
        fromType: "university",
        toType: "state",
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Manage universities, states, and pricing rules for rides.
        </p>
      </div>
        ...
        <TabsContent value="universities">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage the list of universities available for booking
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="states">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage the list of states available for booking
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Add new state */}
        ...
        <TabsContent value="pricing">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Set base prices and vehicle multipliers for different routes
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
