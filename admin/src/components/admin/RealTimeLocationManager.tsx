            ...
            {locations?.states.map((state: StateType) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <span
                    className={state.is_active ? "text-black" : "text-gray-400"}
                  >
                    {state.name}
                  </span>
        ...
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={
                !newUniversity.trim() || addUniversityMutation.isPending
              }
            >
              <Plus className="h-4 w-4 mr-2" />
              Add University
            ...
            {locations?.universities.map((university: UniversityType) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <span
                    className={
                      university.is_active ? "text-black" : "text-gray-400"
                    }
                  >
                    {university.name}
                  </span>
                ...
                <div className="flex gap-1">
                  <Button
                    ...
                    onClick={() =>
                      toggleUniversityMutation.mutate({
                        id: university.id,
                  ...
                  <Button
                    ...
                    variant="destructive"
                    onClick={() =>
                      removeUniversityMutation.mutate(university.id)
                    }
                  >
                    <Trash2 className="h-3 w-3" />
                  </Button>
