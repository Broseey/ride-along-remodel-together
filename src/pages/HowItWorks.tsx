...
import studentImg from "@/assets/images/Students_engaged.jpg";
import facesImg from "@/assets/images/insidecarview.png";
import headerImg from "@/assets/images/605f613840b3a79392e91418_ALL-09-p-1600.jpeg";
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center px-6">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Getting a ride or joining other students for your campus journey is
            easy with Uniride
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Make your payment, receive your confirmation, and get ready for
                a comfortable journey to or from campus.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="w-full md:w-1/2">
              ...
              <p className="text-lg mb-8">
                We've built features to help you stay safe while getting around
                with Uniride, especially when you're joining rides with others.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg mb-12 max-w-3xl mx-auto">
            Uniride connects major universities across Nigeria to key cities and
            towns, making student travel convenient and affordable.
          </p>
