...
const DriverRequirements = () => (
  <HelmetProvider>
    <>
      <Helmet>
        <title>Driver Requirements | Uniride</title>
        <meta
          name="description"
          content="See the requirements for becoming a Uniride driver. Learn what you need to join our trusted driver community."
        />
      </Helmet>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Everything you need to know to become a Uniride driver
            </p>
          </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-green-500" />
                <span>
                  Be a Nigerian citizen or have valid work authorization
                </span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-green-500" />
          ...
          <Card className="mb-8 border-orange-200 bg-orange-50">
            ...
            <CardContent className="text-orange-700">
              <ul className="space-y-2">
                ...
                <li>
                  • Vehicle inspections can be scheduled after document approval
                </li>
                <li>
                  • Commercial insurance is provided by Uniride during active
                  trips
                </li>
              </ul>
            </CardContent>
