  ...
  <HelmetProvider>
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Helmet>
          <title>Privacy Policy | Uniride</title>
          <meta
            name="description"
            content="Read Uniride's privacy policy to learn how we protect your data and privacy while using our ride-sharing platform."
          />
          <meta property="og:title" content="Privacy Policy | Uniride" />
          <meta
            property="og:description"
            content="Read Uniride's privacy policy to learn how we protect your data and privacy while using our ride-sharing platform."
          />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://uniride.ng/privacy-policy" />
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              At Uniride, we respect your privacy and are committed to
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>
                <strong>With Drivers:</strong> Basic contact information and
                pickup/drop-off locations
              </li>
              <li>
                <strong>With Other Riders:</strong> First name and pickup
                location for shared rides
              </li>
              <li>
                <strong>Service Providers:</strong> Payment processors,
                SMS/email services, analytics tools
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              To exercise these rights, contact us at privacy@uniride.com or
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              services and comply with legal obligations. Typically, we keep:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mt-4">
              ...
              <li>
                Location data for 30 days unless longer retention is required
                for safety
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              content. You can control cookie settings through your browser, but
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Nigeria. We ensure appropriate safeguards are in place to protect
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              significant changes via email or app notification. Your continued
