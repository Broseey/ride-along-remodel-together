...
import acrossRoadImg from "@/assets/images/acrossroadImg.jpg";
          ...
          <div className="bg-gray-50 rounded-3xl p-8 shadow-md max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Connect with students for rides between universities and major
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Join other students on their journey. Book your seat on rides that
              match your route.
            </p>
          </div>
